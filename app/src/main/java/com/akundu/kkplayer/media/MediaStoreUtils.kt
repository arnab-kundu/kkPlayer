...
object MediaStoreUtils {
     ...
     */
    fun canReadInMediaStore(context: Context) = checkSelfPermission(context, READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
    ...
    suspend fun createAudioUri(
        ...
        return withContext(Dispatchers.IO) {
            ...
            // This method will perform a binder transaction which is better to execute off the main
            // thread
            return@withContext context.contentResolver.insert(audioCollection, newAudio)
        }
    }
