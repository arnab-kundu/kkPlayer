...
val LightBackground = Color(0x85FFFFFF)
val DarkBackground = Color(0x85444444)

val LightSurface = Color(0xFF444444)
val LightOnSurface = Color(0xFF00172C)
val DarkSurface = Color(0xFFA8ff5A)
val DarkOnSurface = Color(0xFF00172C)

val LightThemeFontColor = Color(0xFF000000)
val DarkThemeFontColor = Color(0xFFFFFFFF)

val LightThemeComponentColor = Color(0xFFFFFFFF)
val DarkThemeComponentColor = Color(0xFFFFFFFF)
