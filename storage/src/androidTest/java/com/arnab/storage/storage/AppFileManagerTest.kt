package com.arnab.storage.storage
...
class AppFileManagerTest {
    ...
    private val APPLICATION_ID:String = "com.akundu.kkplayer"
    ...
    @Before
    fun setUp() {
        fileManager = AppFileManager(APPLICATION_ID)
        ...
        val yourPackage = APPLICATION_ID
        val sampleImageFile = File("/storage/emulated/0/Android/media/${APPLICATION_ID}/testImage.jpeg")
        ...
        val sampleSongFile = File(
            "/storage/emulated/0/Android/media/${APPLICATION_ID}/" +
        ...
        val zipFile = File("/storage/emulated/0/Android/media/${APPLICATION_ID}/10mb.zip")
        if (!zipFile.exists()) {
    ...
    fun testCopyFileSuccessful() {
        ...
        var isCopySuccessful = fileManager.copyFile(
            sourcePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/Tu Hi Meri Shab Hai (Gangster) - K.K - 320Kbps.mp3",
    ...
    fun testCopyFileToObbDirSuccessful() {
        ...
        val isCopySuccessful = fileManager.copyFile(
            sourcePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/testFile.txt",
    ...
    fun testCopyFilePublicMediaDirectorySuccessful() {
        ...
        val isCopySuccessful = fileManager.copyFile(
            sourcePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/Tu Hi Meri Shab Hai (Gangster) - K.K - 320Kbps.mp3",
            destinationPath = "$/storage/emulated/0/Music/Tu Hi Meri Shab Hai (Gangster) - K.K - 320Kbps.mp3"
        )
        assertTrue(isCopySuccessful)
    }
    ...
    fun testCopyFileToAnyRandomDirectoryFailed() {
        val fileManager = AppFileManager(APPLICATION_ID)
        val isCopySuccessful = fileManager.copyFile(
            sourcePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/Tu Hi Meri Shab Hai (Gangster) - K.K - 320Kbps.mp3",
    ...
    fun testRenameFileSuccessful() {
        ...
        val renamedFile = fileManager.renameFile(
            context = appContext,
            existingFilePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/before_renamed_file.txt",
            newFileName = "after_renamed_file.txt"
        )
        val isRenameSuccessful = renamedFile.exists()
        assertTrue(isRenameSuccessful)

        val oldFile = File("/storage/emulated/0/Android/media/${APPLICATION_ID}/before_renamed_file.txt")
    ...
    fun testZipFileSuccessful() {
        ...
        val testOutputFile = fileManager.zipFiles(
            srcFolderPath = "/storage/emulated/0/Android/media/${APPLICATION_ID}",
            destZipFilePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/myTest.zip"
        )
    ...
    fun testZipListOfFilesSuccessful() {
        val fileManager = AppFileManager(APPLICATION_ID)
        val inputPath = "/storage/emulated/0/Android/media/${APPLICATION_ID}"
    ...
    fun testUnzipSuccessful() {
        ...
        fileManager.unZipFileSlowly(
            zipFilePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/10mb.zip",
            extractLocationPath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/"
        )
        ...
        val generatedTestFile = File(
            "/storage/emulated/0/Android/media/${APPLICATION_ID}/big_buck_bunny_240p_10mb.mp4"
        )
    ...
    fun testEncryptFileSuccessful() {
        ...
        val generatedTestFile: File? = fileManager.encryptFile(
            context = appContext,
            srcFilePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/big_buck_bunny_240p_10mb.mp4",
    ...
    fun testDecryptFileSuccessful() {
        ...
        val generatedTestFile: File? = fileManager.decryptFile(
            context = appContext,
            encryptedFilePath = "/storage/emulated/0/Android/media/${APPLICATION_ID}/encrypted-TestFile.enc",
